                ...
                <div class="row payment align-items-center">
                    <div class="col-md-6">
                        <div class="payment-method">
                            <h2>We Accept:</h2>
                            <img src="<?php echo base_url()?>assets/front2/img/payment-method.png" alt="Payment Method" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="payment-security">
                            <h2>Secured By:</h2>
                            <img src="<?php echo base_url()?>assets/front2/img/godaddy.svg" alt="Payment Security" />
                            <img src="<?php echo base_url()?>assets/front2/img/norton.svg" alt="Payment Security" />
                            <img src="<?php echo base_url()?>assets/front2/img/ssl.svg" alt="Payment Security" />
                        </div>
                    </div>
                </div>
            </div>
