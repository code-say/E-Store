...
<body>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2021 Sayan Mandal. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="https://www.instagram.com/sayan.mxndal/">Themeum</a></span></p>
				</div>
			</div>
		</div>
