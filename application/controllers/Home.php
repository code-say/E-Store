...
// Start pagination
		...
		//$config["first_link"] = '<a class="page-link" href="#" tabindex="-1">Previous</a>';

		$config["first_tag_open"] = "<li class='page-item disabled'>";
		$config["first_tag_close"] = "</li>";
		$config["last_link"] = "&raquo;";
		//$config["last_link"] = '<a class="page-link" href="#">Next</a>';
		...
		$config['prev_tag_open'] = '<li class="page-item disabled"><a class="page-link" href="#" tabindex="-1">';
